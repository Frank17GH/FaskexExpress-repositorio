    ...
    class Ctrl {
        ...
        public function __construct() { } 
         ...
         public function tabla1($id){    
            return gList('cargo/table1',$id,'tabla1','vIndicador'); 
        }

        public function mRuta($id){     
            return gList('cargo/mRuta',$id,'apoyo_postal');
        }

        public function mEntregado($dt){     
            return gList('cargo/mEntregado',$dt,'mod1');
        }

        public function mApoyo($dt){     
            return gList('cargo/mEntregado',$dt,'mod1');
        }

        public function mOrden($dt){     
            return gList('cargo/mOrden',$dt,'mod1');
        }
         ...
         public function cre_despacho($dt){     
            ...
            if ($ts) { ?>
                <script>                    
                    ...
                    vAjax('cargo','tabla1','frm1','tbl1');                     
                    vAjax('cargo','mRuta',<?php echo $dt['idapoyo'];?>,'modal2');
        ...
        public function vPrintMan($dt){
            ...
            window.open('<?php echo __IP__.__HOME__.__MOD__; ?>despacho/printMan.php?id=<?php echo $dt ?>', "nuevo", "directories=no, location=no, menubar=no, scrollbars=yes, statusbar=no, tittlebar=no,width="+(screen.availWidth)+",height ="+(screen.availHeight));
            </script><?php
        }
