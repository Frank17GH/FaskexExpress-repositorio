        ...
        <form class="form-horizontal" id="frm1">
            <div class="form-group" style="margin-bottom: 3px;">
                <div class="col-md-12">
                    ...
                    <div class="col-md-2">
                        <select class="form-control" onchange="vops();vAjax('reportes-anulaciones','tabla1','frm1','tbl1')" id="idtin" name="repo">
                    ...
                    <div class="col-md-2 vops" id="rr_dia" style="display: none">
                        <select class="form-control" onchange="vAjax('reportes-anulaciones','tabla1','frm1','tbl1')" name="dia">
                            <?php 
                                for ($i=0; $i < 31; $i++) { 
                                    ?>
                    ...
                    <div class="col-md-2 vops" id="rr_mes" style="display: none">
                        <select class="form-control" onchange="vAjax('reportes-anulaciones','tabla1','frm1','tbl1')" name="mes">
                            <?php 
                                for ($i=0; $i < 12; $i++) { 
                                    ?>
                    ...
                    <div class="col-md-2 vops" id="rr_anio" style="display: none">
                        <select class="form-control" onchange="vAjax('reportes-anulaciones','tabla1','frm1','tbl1')" name="anio">
                            <?php 
                    ...
                    <div class="vops" id="rr_in" style="display: ">
                        ...
                        <div class="col-md-3 ">
                            <input type="date" class="form-control" value="<?php echo date('Y-m').'-01'; ?>" name="inicio" onchange="vAjax('reportes-anulaciones','tabla1','frm1','tbl1');">
                        </div>
                    </div>
                    <div class="vops" id="rr_fn" style="display: ">
                        <div class="col-md-1" style="margin-top: 6px; text-align: right;"><b>FIN:</b></div>
                        <div class="col-md-3">
                            <input type="date" class="form-control" value="<?php echo date('Y-m-t') ?>" name="fin" onchange="vAjax('reportes-anulaciones','tabla1','frm1','tbl1');">
                        </div>
                    </div>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="local" onchange="vAjax('reportes-anulaciones','tabla1','frm1','tbl1')">
                 ...
                 <div class="col-md-4 " style="display: ">
                    <select class="form-control" onchange="vAjax('reportes-anulaciones','tabla1','frm1','tbl1')" name="user">
                        <?php 
                            $class = new Mod();
...
<div class="jarviswidget jarviswidget-color-blueDark" data-widget-editbutton="false">
    ...
    <div>
        ...
        <div class="widget-body no-padding" id="div-tbl1"><script>vAjax('reportes-anulaciones','tabla1','frm1','tbl1');</script></div>
    </div>
</div>
