<?php
    class Ctrl {
        ...
        public function mod1($id){
            return gList($_POST['nom'].'/components/mod1',$id,'mod1'); 
        }
        ...
        public function mod6($id){
            return gList($_POST['nom'].'/components/mod6',$id); 
        }
            ...
            if ($tsArray['@num']) {
                ...
                if ($tsArray['@num']==(int)$dt['correlativo']) {
                    ...
                    <script>
                        ...
                        vAjax('facturacion','table2',0,'prods');
            ...
            if ($ts) {
                ?>
                    <script>
                        ...
                        vAjax('facturacion','table2',0,'prods');$('#myModal3').modal('hide');
                    </script>
                <?php
            }else{
                ?>
