        ...
        <form class="form-horizontal" id="frm1">
            <div class="form-group" style="margin-bottom: 3px;">
                <div class="col-md-12" style="text-align: center;">
                    ...
                    <div class="col-md-2">
                         <select class="form-control" name="estado" onchange="vAjax('productos-categorias','tabla1','frm1','tab1')">
                    ...
                    <div class="col-md-1">
                        <a class="btn btn-labeled btn-primary" onclick="vAjax('productos-categorias','mod1',0,'modal1');"> <span class="btn-label"><i class="fa fa-plus"></i></span><b>Nuevo</b>&nbsp;&nbsp;</a>
                    </div>
...
<div class="jarviswidget jarviswidget-color-blueDark" data-widget-editbutton="false">
    ...
    <div>
        ...
        <div class="widget-body no-padding" id="div-tab1"><script type="text/javascript">vAjax('productos-categorias','tabla1','frm1','tab1');</script></div>
    </div>
</div>
