<?php
    class Ctrl {
        ...
        public function tabla1($dt){     
            return gList('productos-categorias/components/table1',$dt,'tabla1'); 
        }
        public function mod1($dt){     
            return gList('productos-categorias/components/mod1',$dt); 
        }
        public function mod2($dt){     
            return gList('productos-categorias/components/mod2',$dt,'mod2'); 
        }
	        ...
	        if($class->insert1($dt)){     
                ?>
                   <script>
                       	...
                       	$('#myModal1').modal('hide');
                      	vAjax('productos-categorias','tabla1','frm1','tab1');
                    </script>
                <?php
            }else{
