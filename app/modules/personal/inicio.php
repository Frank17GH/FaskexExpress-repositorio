        ...
        <form class="form-horizontal" id="frm1">
            <div class="form-group" style="margin-bottom: 3px;">
                ...
                <div class="col-md-12" style="text-align: center;">
                    ...
                    <button class="btn btn-labeled btn-primary" type="button" onclick="vAjax('despacho','mRut',0,'modal3');"> <span class="btn-label"><i class="fa fa-plus"></i></span><b>Nuevo entrega</b>&nbsp;&nbsp;</button>                                                
