        ...
        public function vDet($Id){      
         ...
         public function vDetalle($Id){      
            return $this->select("SELECT 
                                ...
                                pc.ca_descripcion as tper
                                FROM `despacho` d 
                                join personal p on d.idpersonal = p.idpersonal
                                join personal_cargo pc on p.idpersonalcargo = pc.idpersonalcargo
        ...
        public function saveDet($dt){
         ...
         public function mod1($dt){
          ...
          public function paquete($dt){
                ...
                $serie= $fac[0].'-'.$fac[1];
                $numero= $fac[2];
         return $this->select("SELECT idapoyo,persona,direccion,distrito FROM apoyo_postal where estado=4 and item=".$numero." and etiqueta='".$serie."' ");    
