...
<div role="content">
    <div class="widget-body no-padding">
        ...
        <input type="text" class="form-control" name="idprod" readonly="" value="<?php echo $iddet; ?>"> 
        <!-- MUESTRAS FORMULARIO -->                    
        ...
        <!-- TOTAL GUARDAR --> 
            ...
            <div class="col-md-12" style=" padding: 0px 8px 5px; text-align: right;">                        
                ...
                <?php             
                 if ($idprod===$iddet || $idprod==""){ ?> 
                    <button class="btn btn-primary" type="button" onclick="vAjax('cotizacion','insert2','inspr');">
