            ...
            if ($dt1) {
                ...
                foreach ($dt1 as $dta1): $cc++;
                    ...
                    <tr style="cursor: pointer;">
                        <td>
                            <button type="button" class="btn btn-xs btn-danger" title="Quitar" onclick="confir('Confirmacion','Seguro que deseas quitar paquete seleccionado?','exp_salidaruta','del_temp_com',<?php echo  $dta1[idtemp] ?>+'-/'+<?php echo $dta1[idapoyo] ?>,'remove')">
