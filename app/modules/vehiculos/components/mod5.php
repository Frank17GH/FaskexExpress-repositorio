<div class="modal-header">
	...
	<h4 class="modal-title" id="myModalLabel"><i class=" txt-color-red"></i> CONTROL DE MANTENIMIENTOS </h4>
</div>
			...
			<div class="widget-body">
				<form id="frm2">
					<div class="col-md-12">
						...
						<div class="col-md-4"><input name="fin" type="text" value="" placeholder="Nombre Mecanico" class="form-control" ></div>									
						<div class="col-md-2"><input name="km" type="number" value="" placeholder="Kilometraje" class="form-control"  ></div>
					...
					<div class="col-md-12" style="padding-top: 10px">
						<div class="col-md-4"><input type="text" class="form-control" value="" name="tarea" placeholder="Descripcion del trabajo "></div>
