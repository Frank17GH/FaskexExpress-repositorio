...
$stm=$conexion->prepare("SELECT iduser,concat(substring_index(pe_nombres,' ',1),' ', pe_apellidos) as  pe_nombres,pe_apellidos,local_pre,tipo,l.idlocales,l.idgiros,c.us_rol as rol, p.pe_mail as correo 
