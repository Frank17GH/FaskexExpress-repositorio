        ...
        <form class="form-horizontal" id="frm_prod">
            <div class="form-group" style="margin-bottom: 3px;">
                ...
                <div class="col-md-2" style="text-align: right;">
                    <div class="btn-group">
                        <a class="btn btn-labeled btn-primary" onclick="vAjax('clientes','mNewClient',1,'prod');"> <span class="btn-label"><i class="fa fa-plus"></i></span><b>Nuevo</b>&nbsp;&nbsp;</a>
                    </div>
                </div>
                <div class="col-md-10">
                </div>
...
<div class="jarviswidget jarviswidget-color-blueDark" data-widget-editbutton="false">
    ...
    <div>
        ...
        <div class="widget-body no-padding" id="div-clientes_listar"><script type="text/javascript">vAjax('clientes','tabla1',0,'clientes_listar');</script></div>
    </div>
</div>
