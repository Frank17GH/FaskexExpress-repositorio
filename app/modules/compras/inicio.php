        ...
        <form class="form-horizontal" id="frm1">
            <div class="form-group" style="margin-bottom: 3px;">
                <div class="col-md-9">
                    ...
                    <div class="col-md-2 vops" id="rr_dia">
                        <select class="form-control" onchange="vAjax('compras','tabla1','frm1','tbl1')" name="dia">
                            <?php 
                                for ($i=0; $i < 31; $i++) { 
                                    ?>
                    ...
                    <div class="col-md-2 vops" id="rr_mes">
                        <select class="form-control" onchange="vAjax('compras','tabla1','frm1','tbl1')" name="mes">
                            <?php 
                                for ($i=0; $i < 12; $i++) { 
                                    ?>
                    ...
                    <div class="col-md-2 vops" id="rr_anio">
                        <select class="form-control" onchange="vAjax('compras','tabla1','frm1','tbl1')" name="anio">
                    ...
                    <div class="vops" id="rr_in" style="display: none">
                        ...
                        <div class="col-md-3 ">
                            <input type="date" class="form-control" value="<?php echo date('Y-m').'-01'; ?>" name="inicio" onchange="vAjax('compras','tabla1','frm1','tbl1');">
                        </div>
                    </div>
                    <div class="vops" id="rr_fn" style="display: none">
                        <div class="col-md-1" style="margin-top: 6px; text-align: right;"><b>FIN:</b></div>
                        <div class="col-md-3">
                            <input type="date" class="form-control" value="<?php echo date('Y-m-t') ?>" name="fin" onchange="vAjax('compras','tabla1','frm1','tbl1');">
                        </div>
                    </div>
                ...
                <div class="col-md-1" style="text-align: right;">
                    <div class="btn-group">
                        <a class="btn btn-labeled btn-primary" onclick="vAjax('compras','tabla1','frm1','tbl1')"> <span class="btn-label"><i class="fa fa-search"></i></span><b>Buscar</b>&nbsp;&nbsp;</a>
                    </div>
                </div>
                <div class="col-md-2" style="text-align: left;">
                    <div class="btn-group">
                        <a class="btn btn-labeled btn-info" onclick="vAjax('compras','mod1',0,'modal3')"> <span class="btn-label"><i class="fa fa-plus"></i></span><b>AGREGAR</b>&nbsp;&nbsp;</a>
                    </div>
                </div>
                <div class="col-md-10">
                </div>
...
<div class="jarviswidget jarviswidget-color-blueDark" data-widget-editbutton="false">
	<header>
        ...
        <h2>Reporte de Compras Registradas</h2>
    ...
    <div>
        ...
        <div class="widget-body no-padding" id="div-tbl1"><script>vAjax('compras','tabla1','frm1','tbl1');</script></div>
    </div>
</div>