...
<div class="form-group">
    ...
    <div class="col-md-2">
        <div class="form-group has-primary"> 
            ...
            <span class="input-group-addon"><i class="fa fa-num"> <input id="vserie"></i></span>
            <input type="text" name="orden" onkeydown=" if(event.keyCode === 13){ Orden($(this).val()); $('#numorden').val($(this).val()); return false; }" placeholder="# Orden de Servicio" class="form-control">                              
        </div>
    </div>
            ...
            <div class="col-md-12">                    
                <select class="form-control input-xs" id="iddis" name="iddistrito">
                   ...
                   <?php 
                        $ts = $class->dis_tabla();
                        foreach ($ts as $ts1): 
                            ?><option value="<?php echo $ts1['iddistrito'] ?>" <?php echo  ($ts1[iddistrito]==$dt1[0][iddistrito])?'selected':''; ?>><?php ech o $ts1[nombre] ?></option><?php 
                         endforeach;
                    ?> 
                </select>                
            </div>
