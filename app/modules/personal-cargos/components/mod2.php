										...
										<fieldset>
											<div class="form-group">
												...
												<div class="col-md-8">
													<span class="view"><?php 
															if ($dta['ca_ambito']=='1') {
																?><a class="btn btn-primary btn-sm" href="javascript:void(0);">&nbsp;&nbsp;LOCAL&nbsp;&nbsp;</a><?php
															}else{
																?><a class="btn btn-primary btn-sm" href="javascript:void(0);">NACIONAL</a><?php
															}
															
														?></span>
													<select name="ambito" style="display: none" class="form-control edit">
														<option value="1" <?php echo ($dta['ca_ambito']=='1')?'selected':''; ?>>LOCAL</option>
														<option value="2" <?php echo ($dta['ca_ambito']=='2')?'selected':''; ?>>NACIONAL</option>
													</select>
												</div>
