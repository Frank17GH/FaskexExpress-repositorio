...
<div class="modal-header">
	...
	<h4 class="modal-title" id="myModalLabel"><center><b>NUEVO CARGO</b></center></h4>
</div>
						...
						<fieldset>
							<div class="col-md-12">
								<div class="form-group">
									<label class="col-md-4">Ambito</label>
									<div class="col-md-8">
										<select name="ambito" style="" class="form-control edit">
