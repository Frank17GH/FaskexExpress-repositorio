<?php 
    ...
    $tsArray3= $funcion->vDet_com($_GET['id']);	
  		...
  		<table>
  			<tr>
  				...
  				<td style="width: 29%;vertical-align: top;">
  					<table style="border: 1px solid black; width: 100%;border-spacing: 0 1.2em;font-size: 18px;border-radius: 20px;top: 0px">
  						...
  						<tr>
  							<td>
  								<b><center>GUIA DE SALIDA</center></b>
  							</td>
  						</tr>
  						<tr>
  							<td>
  								<center><b><?php echo $data['de_serie'].' - '.$data['de_codigo'] ;?></b></center>
  							</td>
  						</tr>
  					</table>
  			...
  			<hr>
  				<table style="width: 100%;font-size: 12px">
  					<tr>
		  				...
		  				<td style="width: 90px"><b>Fecha Registro </b></td>
  					...
  					<tr>
		  				...
		  				<td style="width: 90px"><b>Distrito </b></td>
		  				<td style="width: 10px">:</td>
		  				<td style="width: auto"><?php echo $data['distrito'] ?></td>
		  				<td style="width: 90px"><b>Fecha Cierre </b></td>
		  				<td style="width: 10px">:</td>
		  				<td style="width: auto"><?php echo $data['de_fechacierre']; ?></td>
  					</tr>
  					<tr>
  						<td style="width: 70px;">
							<b>Observacion: </b></td>
			...
			<table style="border: 0.1px solid #000000;
	          ...
	          <tr>
	            ...
	            <th style="padding: 3px; background: #dfdede;border: 0.1px solid #000000;color: #000000;text-align: left;font-size: 11px;text-align: center; width: 15%;">Orden - Comprobante</th>	            
	            ...
	            <th style="padding: 3px; background: #dfdede;border: 0.1px solid #000000;color: #000000;text-align: left;font-size: 11px;text-align: center; width: 14%;">Peso</th>
	          ...
	          <?php $cc=0;$total=0; $peso = 0;?>
  				<?php foreach ($tsArray2 as $dt):$cc++;$total+=$dt['cantidad']; $peso+=$dt['peso'];  ?>
			  		<tr>
			  			...
			  			<td style="border: 0.1px solid #000000;color: #000000;text-align: left;font-size: 10px;padding: 3px;"><?php echo $dt['peso'] ?></td>
			  			<td style="border: 0.1px solid #000000;color: #000000;text-align: left;font-size: 10px;padding: 3px;"><?php echo $total;?></td>
			  			
			  		</tr>
			  	<?php endforeach ?>

			  	<?php foreach ($tsArray3 as $dt3):$cc++; $total+=$dt3['cantidad'];if($dt3['medida']=='G'){$pes=$dt3['peso']/1000;}else{$pes=$dt3['peso'];};$peso+=$pes;  ?>
			  		<tr>
			  			<td style="border: 0.1px solid #000000;color: #000000;text-align: left;font-size: 10px;padding: 3px;"><?php echo $cc; ?></td>
			  			<td style="border: 0.1px solid #000000;color: #000000;text-align: left;font-size: 10px;padding: 3px;"><?php echo $dt3['co_serie'].' - '. str_pad($dt3['co_correlativo'], 8, "0", STR_PAD_LEFT); ?></td>			  			
			  			<td style="border: 0.1px solid #000000;color: #000000;text-align: left;font-size: 10px;padding: 3px;"><?php echo $dt3['co_nombre_envia'] ?></td>
			  			<td style="border: 0.1px solid #000000;color: #000000;text-align: left;font-size: 10px;padding: 3px;"><?php echo $dt3['de_descrip'] ?></td>
			  			<td style="border: 0.1px solid #000000;color: #000000;text-align: left;font-size: 10px;padding: 3px;"><?php echo $dt3['co_fecha'] ?></td>
			  			<td style="border: 0.1px solid #000000;color: #000000;text-align: left;font-size: 10px;padding: 3px;"><?php echo ($dt3['medida']=='G')? $dt3['peso']/1000: $dt3['peso'];?></td>
			  			<td style="border: 0.1px solid #000000;color: #000000;text-align: left;font-size: 10px;padding: 3px;"><?php echo $dt3['cantidad'];?></td>
	      	...
	      	<div style="width: 29%;display: inline-flex;">
	      		<table style="border: 0.1px solid #000000;
		        	...
		        	<tr>
		            	<th style="padding: 3px; background: #dfdede;border: 0.1px solid #000000;color: #000000;text-align: left;font-size: 11px;width: 50%;">PESO TOTAL Kg.</th>
		            	<th style="padding: 3px;border: 0.1px solid #000000;color: #000000;text-align: left;font-size: 11px;width: 50%;text-align: right;"><?php echo number_format($peso,3) ?></th>
		        	</tr>
