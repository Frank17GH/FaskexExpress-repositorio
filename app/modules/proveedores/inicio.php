        ...
        <form class="form-horizontal" id="frm_prod">
            <div class="form-group" style="margin-bottom: 3px;">
                ...
                <div class="col-md-2" style="text-align: right;">
                    <div class="btn-group">
                        <a class="btn btn-labeled btn-primary" onclick="vAjax('proveedores','mod1',1,'modal5');"> <span class="btn-label"><i class="fa fa-plus"></i></span><b>Nuevo</b>&nbsp;&nbsp;</a>
                    </div>
                </div>
                <div class="col-md-10">
                </div>
...
<div class="jarviswidget jarviswidget-color-blueDark" data-widget-editbutton="false">
    ...
    <div>
        ...
        <div class="widget-body no-padding" id="div-tbl1"><script>vAjax('proveedores','tabla1',0,'tbl1');</script></div>
    </div>
</div>