    ...
    <div class="panel-body" style="padding-bottom: 0px; padding-top: 4px;"><br>
        <form class="form-horizontal" id="frm1">
            <div class="form-group" style="margin-bottom: 3px;">
                <div class="col-md-10">
                    <div class="col-md-2">
                        <select class="form-control" onchange="vops2()" id="idtin" name="repo">
                    ...
                    <div class="col-md-2">
                        <select class="form-control" name="local" >
                            ...
                            <?php 
                                ...
                                foreach ($dt1 as $dta1):
                                    ?>
                                        <option value="<?php echo $dta1['idlocales'] ?>"><?php echo mb_strtoupper($dta1['lo_abreviatura']) ?></option>
                                    <?php
                                endforeach; 
                            ?>
                        </select>
                    ...
                    <script>
                        function vops2(){
                            ...
                            $('#div-tbl1').html('<br><br><center>Click en buscar</center>');
                        }
                    </script>
                    ...
                    <div class="vops" id="rr_in" style="display: none">
                        ...
                        <div class="col-md-3 ">
                            <input type="date" class="form-control" value="<?php echo date('Y-m').'-01'; ?>" name="inicio">
                        </div>
                    </div>
                    <div class="vops" id="rr_fn" style="display: none">
                        <div class="col-md-1" style="margin-top: 6px; text-align: right;"><b>FIN:</b></div>
                        <div class="col-md-3">
                            <input type="date" class="form-control" value="<?php echo date('Y-m-t') ?>" name="fin">
                        </div>
                    </div>
                ...
                <div class="col-md-2" style="text-align: right;">
                    <div class="btn-group">
                        <a class="btn btn-labeled btn-primary" onclick="vAjax('reportes-caja','tabla1','frm1','tbl1')"> <span class="btn-label"><i class="fa fa-search"></i></span><b>Buscar</b>&nbsp;&nbsp;</a>
                    </div>
                </div>
                <div class="col-md-10">
                </div>
...
<div class="jarviswidget jarviswidget-color-blueDark" data-widget-editbutton="false">
	<header>
        ...
        <h2>Reporte de Cajas Registradas</h2>
    ...
    <div>
        ...
        <div class="widget-body no-padding" id="div-tbl1"><script>vAjax('reportes-caja','tabla1','frm1','tbl1');</script></div>
    </div>
</div>
