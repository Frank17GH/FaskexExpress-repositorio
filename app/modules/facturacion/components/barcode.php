    ...
    if ($ts){
    	foreach ($ts as $ts1): 
    	  $code2 = $ts1['serie'].'-'.str_pad($ts1['correlativo'], 8, "0", STR_PAD_LEFT) ;
    	      ?>     <script>                       
                        aviso('info','Etiquetas 8 X 5 cm generadas correctamente!','Correcto!');
                    </script>
                    <?php 
    ?>    
	       <div id="field" >
				...
				<div style="letter-spacing: 13px;margin-left:30px;font-size: 9px;padding:1px;" ><?php echo $code2; ?></div>
