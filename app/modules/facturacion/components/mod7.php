            ...
            <form id="vvprod">
                ...
                <div class="form-group">
                    <div class="col-md-3">
                        ...
                        <input class="form-control" name="bus_prod" placeholder="Buscar producto" onkeyup="if(event.keyCode == 13) vAjax('facturacion','table3','vvprod','tbl3')">
                    </div>
                    <div class="col-md-2">
...
<script> $('#bus_prod').select();vAjax('facturacion','table3','vvprod','tbl3');
</script>